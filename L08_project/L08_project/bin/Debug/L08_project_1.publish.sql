...
GO
:setvar DatabaseName "Dev1"
:setvar DefaultFilePrefix "Dev1"
...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [secondary_A7D13C], FILENAME = N'$(DefaultDataPath)$(DefaultFilePrefix)_secondary_A7D13C.mdf') TO FILEGROUP [secondary];
